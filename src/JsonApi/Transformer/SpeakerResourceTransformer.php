  ...
  public function getAttributes($speaker): array {
    return [
      ...
      'datecreated' => function (Speaker $speaker) {
        return ($speaker->getDatecreated()) ? $speaker->getDatecreated()
          ->format(DATE_ATOM) : NULL;
      },
      'datemodified' => function (Speaker $speaker) {
        return ($speaker->getDatemodified()) ? $speaker->getDatemodified()
          ->format(DATE_ATOM) : NULL;
      },
      ...
      'datesuggested' => function (Speaker $speaker) {
        return ($speaker->getDatesuggested()) ? $speaker->getDatesuggested()
          ->format(DATE_ATOM) : NULL;
      },
      ...
      'recbiodate' => function (Speaker $speaker) {
        return ($speaker->getRecbiodate()) ? $speaker->getRecbiodate()
          ->format(DATE_ATOM) : NULL;
      },
      ...
      'recphotodate' => function (Speaker $speaker) {
        return ($speaker->getRecphotodate()) ? $speaker->getRecphotodate()
          ->format(DATE_ATOM) : NULL;
      },
      ...
      'recwaiverdate' => function (Speaker $speaker) {
        return ($speaker->getRecwaiverdate()) ? $speaker->getRecwaiverdate()
          ->format(DATE_ATOM) : NULL;
      },
      ...
      'photomoddate' => function (Speaker $speaker) {
        return ($speaker->getPhotomoddate()) ? $speaker->getPhotomoddate()
          ->format(DATE_ATOM) : NULL;
      },
      ...
      'rolechangedate' => function (Speaker $speaker) {
        return ($speaker->getRolechangedate()) ? $speaker->getRolechangedate()
          ->format(DATE_ATOM) : NULL;
      },
